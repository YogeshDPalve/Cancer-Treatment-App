  ...
  return (
    <div className="flex flex-col rounded-xl border border-neutral-800 bg-[#13131a] shadow-sm">
      ...
      <a
        ...
        className="rounder-b-xl inline-flex cursor-pointer items-center justify-between border-t border-neutral-400 px-4 py-3 text-sm text-gray-600 hover:bg-neutral-800 md:px-5"
      >
        {record.recordName}
        <IconChevronRight />
      </a>
